...
onMounted(async () => {
  if ((+route.params.id).toString() !== "NaN") {
    ...
    await axios
      .get(
        `https://seasonreal.seasonsge.com/appv1real/hotel--rr?id=${userId.id}`
      )
      .then((data) => {
        // console.log(data);
        ...
        axios
          .get("https://seasonreal.seasonsge.com/appv1real/all-hotel")
          .then((data) => {
    ...
    await axios
      .get(
        `https://seasonreal.seasonsge.com/appv1real/room_only?id=${bookInfo.value.code}`
      )
      .then((data) => {
    ...
    await axios
      ...
      .then((data) => {
        ...
        axios
          .get(
            `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${bookInfo.value.account_name}`
          )
          .then((data) => {
