<template>
  ...
  <div ref="checkout" class="orderSummary" dir="ltr">
    ...
    <table>
      ...
      <tbody>
        <tr v-for="(item, index) in allCities" :key="index">
          ...
          <td>
            {{
              bookInfo.details.includes_flight == "1"
    ...
    <table
      class="mt-5"
      v-if="bookInfo.Include_flight == '1' && flightTrip !== undefined"
    >
      <thead>
        <tr>
          <th>Departure Time</th>
...
onMounted(async () => {
  ...
  if ((+route.params.id).toString() !== "NaN") {
    ...
    await axios
      .get(`https://seasonreal.seasonsge.com/appv1real/br-rr?id=${userId.id}`)
      .then((data) => {
        ...
        axios
          .get("https://seasonreal.seasonsge.com/appv1real/all-program")
          .then((data) => {
        ...
        axios
          .post(
            `https://seasonreal.seasonsge.com/appv1real/country-by-id`,
            country
          )
          .then((data) => {
        ...
        axios
          .get("https://seasonreal.seasonsge.com/appv1real/cities-view")
          .then((data) => {
        ...
        if (bookInfo.value.Include_flight == "1") {
          axios
            .get("https://seasonreal.seasonsge.com/appv1real/flights?all")
            .then((data) => {
              ...
              if (flightTrip.value !== undefined) {
                axios
                  .get(
                    "https://seasonreal.seasonsge.com/appv1real/airlines-view"
                  )
                  .then((data) => {
                ...
                axios
                  .get(
                    "https://seasonreal.seasonsge.com/appv1real/viewAirports"
                  )
                  .then((data) => {
                    if (data.data.success) {
        ...
        axios
          .get(
            `https://seasonreal.seasonsge.com/appv1real/pr-data?id=${bookInfo.value.brogram_id}`
          )
          .then((data) => {
    ...
    axios
      .get("https://seasonreal.seasonsge.com/appv1real/cars-type-view")
      .then((data) => {
    ...
    await axios
      .get(
        `https://seasonreal.seasonsge.com/appv1real/get-room?id_hotel=${bookInfo.value.booking_id}`
      )
      .then((data) => {
        console.log(data);
    ...
    await axios
      .get(
        `https://seasonreal.seasonsge.com/appv1real/boking-search?booking_code=${route.params.id}`
      )
      .then((data) => {
        ...
        if (bookInfo.value.Include_flight == "1") {
          axios
            ...
            .then((data) => {
              ...
              axios
                .get("https://seasonreal.seasonsge.com/appv1real/airlines-view")
                .then((data) => {
                  if (data.data.success) {
                    console.log(
                      "flightTrip.value.flightLine",
              ...
              axios
                .get("https://seasonreal.seasonsge.com/appv1real/viewAirports")
                .then((data) => {
                  if (data.data.success) {
                    flightTrip.value["from"] = data.data.data.filter(
                      (element) => element.id == flightTrip.value.fromAirport
        ...
        axios
          .get(
            `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${bookInfo.value.email}`
          )
          .then((data) => {
