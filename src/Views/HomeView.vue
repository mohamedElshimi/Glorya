  ...
  <div class="home-page">
    ...
    <section class="my-5 img-overlay d-flex justify-content-center align-items-center">
      <div class="d-flex flex-wrap align-items-center col-lg-6 col-md-8 col-10 text-center justify-content-between">
        ...
        <button class="btn btn-light col-lg-6 lg:mt-0 mt-3 fw-semibold text-lg">
          <i class="fa-brands fa-whatsapp me-3 text-success"></i
          >{{ $t("home.sec4.btn") }}
        </button>
      </div>
    </section>
    ...
    >
      <div class="col-10 mx-auto my-5">
        <div
          class="d-flex flex-wrap md:justify-content-between justify-content-center"
        >
          <div
            class="text-center col-lg-3 col-md-6 mx-auto mt-3"
    ...
    <section class="my-10">
      ...
      >
        <swiper-slide
          ><img src="../../public/images/image1.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image2.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image3.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image4.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image5.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image6.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image7.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image8.png" class="w-100" alt=""
        /></swiper-slide>
        <swiper-slide
          ><img src="../../public/images/image9.png" class="w-100" alt=""
        /></swiper-slide>
      </swiper>
    </section>
    <section
    ...
    >
      ...
      >
        ...
        <router-link
          :to="`/${$i18n.locale}/createJourney`"
          class="btn btn-light col-md-6 mt-md-0 mt-3 fw-semibold"
          >{{ $t("home.sec8.btn") }}</router-link
        >
      </div>
    </section>
...
const search = async () => {
  ...
  if (!validation.value.$error) {
    ...
    await axios
      .post(
        `https://seasonreal.seasonsge.com/appv1real/booking_search`,
        formData
      )
      .then((data) => {
        ...
        if (data.data.bookings && data.data.bookings.length > 0) {
          ...
          axios
            .get(
              `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${carsBooking.account_owner}`
            )
            .then((data) => {
              loading.value = false;
              if (data.data.type == 2) {
          ...
          axios
            .get(
              `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${flightsBooking.email}`
            )
            .then((data) => {
              loading.value = false;
              if (data.data.type == 2) {
          ...
          data.data.hotel_reservations &&
          data.data.hotel_reservations.length > 0
        ) {
          const HotelsBooking = data.data.hotel_reservations[0];
          axios
            .get(
              `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${HotelsBooking.account_name}`
            )
            .then((data) => {
              loading.value = false;
              if (data.data.type == 2) {
          ...
          axios
            .get(
              `https://seasonreal.seasonsge.com/appv1real/user-data?user_id=${ProgramsBooking.email}`
            )
            .then((data) => {
              loading.value = false;
              if (data.data.type == 2) {
...
onMounted(async () => {
  await axios
    .get(`https://seasonreal.seasonsge.com/appv1real/images`)
    .then((res) => {
