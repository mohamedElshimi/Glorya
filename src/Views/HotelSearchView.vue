    ...
    <div class="hotel-search">
        ...
        <div>
            <div class="search-box p-4">
                ...
                <HotelTable v-else-if="forward === '2'" :searchResults="searchResults" :searchInfo="searchInfo"
                    @back-ward="() => { forward = '1', searchResults = [] }" @getIdAndForward="getIdAndForward">
                </HotelTable>
                <HotelBook v-else-if="forward === '3'" @back-ward="forward = '2'" :searchInfo="searchInfo"
