<template>
    <div class="cars-search">
        ...
        <div class="search-box p-4">
            ...
            <CarsTableComp v-else-if="forward === '2'" :searchInfo="searchInfo" @back-ward="forward = '1'"
                @getIdAndForward="getIdAndForward">
            </CarsTableComp>
            <CarsDetailsComp :city="city" :country="country" v-else-if="forward === '3'" @back-ward="forward = '2'" :searchInfo="searchInfo" :carId="carId">
            </CarsDetailsComp>
...
import CarsTableComp from './CarsTableComp.vue';
import CarsDetailsComp from './CarsDetailsComp.vue';
